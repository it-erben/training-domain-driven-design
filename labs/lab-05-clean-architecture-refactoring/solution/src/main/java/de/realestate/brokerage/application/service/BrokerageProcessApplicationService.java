...
public class BrokerageProcessApplicationService {
     ...
     */
    public BrokerageProcess create(UUID propertyId, Address address,
                                    AskingPrice askingPrice, Commission commission) {
        BrokerageProcess process = BrokerageProcess.create(propertyId, address, askingPrice, commission);
