...
public class Vermittlungsvorgang {
    ...
    public Vermittlungsvorgang(UUID id, UUID immobilieId, Adresse adresse,
        ...
        this.status = status;
        this.besichtigungen = new ArrayList<>(besichtigungen != null ? besichtigungen : List.of());
        this.angebote = new ArrayList<>(angebote != null ? angebote : List.of());
        this.domainEvents = new ArrayList<>();
    }

    /**
     * Factory method to create a new Vermittlungsvorgang with status NEU.
     */
    public static Vermittlungsvorgang erstellen(UUID immobilieId, Adresse adresse,
        ...
        return new Vermittlungsvorgang(
                ...
                preisvorstellung,
                provision,
                VermittlungsvorgangStatus.NEU,
                new ArrayList<>(),
                new ArrayList<>()
        );
    }

    public void besichtigungHinzufuegen(String interessentName, LocalDateTime zeitpunkt, String notizen) {
    ...
    public void besichtigungDurchfuehren(UUID besichtigungId) {
        ...
        domainEvents.add(new BesichtigungDurchgefuehrt(
                this.id,
                besichtigungId,
                LocalDateTime.now()
        ));
    ...
    public void angebotEntgegennehmen(String interessentName, BigDecimal betrag) {
        ...
        domainEvents.add(new AngebotEingegangen(
                this.id,
                betrag,
                LocalDateTime.now()
        ));
    ...
    public void angebotAnnehmen(UUID angebotId) {
        ...
        domainEvents.add(new AngebotAngenommen(
                this.id,
                angebotId,
                LocalDateTime.now()
        ));
    ...
    public void statusAufNotarterminSetzen() {
        ...
        if (!hatAngenommenesAngebot) {
            throw new IllegalStateException(
                    "Notartermin kann nur gesetzt werden, wenn mindestens ein angenommenes Angebot vorliegt");
        }
