# Lab 03b: Event Storming – Eure eigene Fachdomäne

## Lernziel

Die in Lab 03 erlernte Event-Storming-Methode auf die eigene Fachdomäne
...
## Farbcodierung (Wiederholung aus Lab 03)
...
> Es ist OK, wenn die Grenzen nicht perfekt sind. In Lab 04 (Strategic Design)
...
- **Vergleicht mit Lab 03.** Was war beim Immobilien-CRM einfacher? Warum? Oft
...
- **Die Ergebnisse sind Arbeitsgrundlage.** Fotografiert oder exportiert euer
  Board. Es wird in Lab 04 (Strategic Design) weiterverwendet, und am Ende des
  Workshops (Lab 13) könnt ihr Teile davon in Code übersetzen.
