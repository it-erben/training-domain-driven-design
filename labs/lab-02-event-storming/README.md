...
Event Storming als Methode anwenden, um die Immobilien-CRM-Domäne zu erkunden.
Domain Events, Commands, Aggregates, Policies und externe Systeme
identifizieren.
...
Führe ein Event Storming für die Immobilien-CRM-Domäne durch. Ziel ist es, die
wichtigsten Geschäftsprozesse eines Immobilienmaklers als zeitliche Abfolge von
Domain Events zu modellieren.
...
dir einfallen. Schreibe jedes Event auf einen orangefarbenen Sticky Note in der
**Vergangenheitsform**.
...
**Tipp:** Denke nicht zu lange nach - schreibe einfach alles auf, was dir
einfällt. Sortieren kommt später.

### Phase 2: Zeitlinie ordnen (5-10 Min)

Ordne die gesammelten Domain Events auf einer horizontalen Zeitlinie von links (
früh) nach rechts (spät). Gruppiere zusammengehörige Events.
...
- **Actor:** Wer hat den Command ausgelöst? (Makler, Eigentümer, Interessent,
  System)
...
- [ ] Die wichtigsten **Actors** sind benannt (Makler, Eigentümer, Interessent,
  System)
...
- Diskutiert im Team über unterschiedliche Begriffe - genau da verstecken sich
  oft die Bounded Contexts (siehe Lab 03).
