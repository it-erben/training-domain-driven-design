# Lab 04: Strategic Design - Bounded Contexts und Context Map
...
- Lab 03 (Event Storming) abgeschlossen
- Ergebnisse des Event Stormings liegen vor (Domain Events, Aggregates, Policies)

## Aufgabe

Leite aus dem Event Storming Bounded Contexts ab und erstelle eine Context Map für die Immobilien-CRM-Domäne.
...
1. **Wo ändert sich die Bedeutung eines Begriffs?**
   - Beispiel: "Immobilie" bedeutet in der Objektverwaltung etwas anderes (Stammdaten, Flächen, Ausstattung) als in der Vermarktung (Expose-Texte, Fotos, Zielgruppe).

2. **Welche Events gehören zusammen?**
   - Events, die immer gemeinsam auftreten oder eng zusammenhängen, gehören wahrscheinlich zum selben Bounded Context.

3. **Wo gibt es unterschiedliche Experten?**
   - Wenn verschiedene Personen oder Abteilungen für bestimmte Themen zuständig sind, deutet das auf getrennte Bounded Contexts hin.

4. **Was könnte unabhängig deployed werden?**
   - Teile des Systems, die sich unabhängig voneinander ändern und deployen lassen, sind gute Kandidaten für eigene Bounded Contexts.

**Vorgehen:**

- Zeichne auf dem Event-Storming-Board Linien um die Gruppen von Events, die zusammengehören.
- Gib jedem Bereich einen sprechenden Namen.
- Prüfe, ob die Gruppen in sich schlüssig sind und klare Verantwortlichkeiten haben.
...
- Zeichne die Context Map als Diagramm mit Kästen (Bounded Contexts) und Pfeilen (Beziehungen).
...
- Die Ergebnisse dieses Labs bilden die Grundlage für die Code-Labs ab Lab 05 (Building Blocks).
