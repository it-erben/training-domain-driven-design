...
public class Viewing {
    ...
    Viewing(UUID id, String prospectName, LocalDateTime timestamp) {
        this(id, prospectName, timestamp, "");
    }

    private Viewing(UUID id, String prospectName, LocalDateTime timestamp, String notes) {
