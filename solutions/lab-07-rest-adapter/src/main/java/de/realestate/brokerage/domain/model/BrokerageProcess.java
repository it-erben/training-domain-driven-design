...
public class BrokerageProcess {
    ...
    /**
     * Reconstitutes an existing BrokerageProcess from persistence.
     */
    ...
    public static BrokerageProcess create(UUID propertyId,
        ...
        return new BrokerageProcess(UUID.randomUUID(), propertyId,
    ...
    public void completeViewing(UUID viewingId) {
        Viewing viewing = viewings.stream()
                ...
                .findFirst()
                .orElseThrow(() -> new ViewingNotFoundException(id, viewingId));
