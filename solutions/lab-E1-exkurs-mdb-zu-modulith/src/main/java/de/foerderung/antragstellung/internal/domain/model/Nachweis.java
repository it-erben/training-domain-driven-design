...
public class Nachweis {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Nachweis nachweis)) return false;
    ...
    public NachweisId getId() { return id; }
    public String getDokumentTyp() { return dokumentTyp; }
    public String getEingereichtVon() { return eingereichtVon; }
    public Instant getEingereichtAm() { return eingereichtAm; }
    public boolean isAkzeptiert() { return akzeptiert; }
}
