...
public class Flurstueck {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Flurstueck flurstueck)) return false;
    ...
    public FlurstueckId getId() { return id; }
    public FlurstueckNummer getNummer() { return nummer; }
    public BigDecimal getFlaeche() { return flaeche; }
    public String getBemerkung() { return bemerkung; }
    public boolean isGeprueft() { return geprueft; }
}
