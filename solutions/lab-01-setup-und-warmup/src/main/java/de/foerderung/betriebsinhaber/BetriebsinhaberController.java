...
public class BetriebsinhaberController {
    ...
    public Betriebsinhaber freigeben(@PathVariable Long id) {
        return service.freigeben(id);
    }

    @PostMapping("/{id}/stilllegen")
    public Betriebsinhaber stilllegen(@PathVariable Long id) {
        return service.stilllegen(id);
    }
}
